...
call actualizar_precios(1, 'VINAGRES');
...
--  procedimiento para calcular  detalle comision/cliente /empleado / año utilizando funcion 
...
/* Funcion calcula el importe gastado por cliente en un año pasado como parametro */

drop function if exists importe_cliente_anio;
delimiter $$
